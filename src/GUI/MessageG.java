 ...
 * @author emad
 */
public class MessageG extends javax.swing.JInternalFrame {

    /**
     * Creates new form MessageG
     */
    Person Per;
    public MessageG(Person P) {
        Per=P;
      ((javax.swing.plaf.basic.BasicInternalFrameUI) this.getUI()).setNorthPane(null);                        
        initComponents();
        System.out.println(P.ID);
        ArrayList<Message> M=P.RecieveMessages();
        System.out.println(M.size()+"aaaaaaaaa");
        ...
        {
            String Mail=Sys.GetSystem().Get_Email(M.get(i).SenderID);
            JL.get(i).setText("From:"+Mail+": "+System.lineSeparator()+M.get(i).Content);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        SendMessage M=new SendMessage(Per);
        ManagerHome.ManagerView.add(M);
        M.setVisible(true);   
