...
--
-- Host: localhost
-- Generation Time: May 12, 2017 at 06:19 AM
...
INSERT INTO `bill` (`ID`, `Item_ID`, `Date_Id`, `Price`, `User_ID`, `DM_ID`) VALUES
(1, 2, 1, 2000, 4, 3),
(2, 1, 2, 5000, 5, 9),
(3, 4, 3, 4000, 7, 9),
(4, 3, 4, 8000, 6, 3);
...
--
-- Dumping data for table `dm_work_table`
--

INSERT INTO `dm_work_table` (`ID`, `DM_ID`, `DATE_ID`) VALUES
(1, 3, 1),
(2, 9, 1);
...
--
-- Dumping data for table `order_of_item`
--

INSERT INTO `order_of_item` (`ID`, `BidderID`, `AdminID`, `DM_ID`, `Avilabletime_ID`, `Item_ID`) VALUES
(1, 6, 2, 3, 1, 1),
(2, 4, 2, 3, 2, 2),
(6, 11, 2, 9, 3, 3);
...
(1, 'Mohamed', 'Salah', 'Eng.mohamed161996@gmail.com', '12345678', 1, 70000012, 1),
(2, 'Kareem', 'Alaa', 'Kareemalaa45@gmail.com', '14785236', 2, 99119, 1),
(3, 'Emad', 'Sayed', 'EmadSayed12@gmail.com', '36985214', 3, 6022, 1),
(4, 'Mahmoud', 'Abdelrazek', 'MahmoudAbdelrazek14@gmail.com', '25874136', 4, 25841, 2),
(5, 'Abdalla', 'mohamed', 'AbdallaMohamed78@gmail.com', '36974125', 5, 25874, 3),
...
(10, 'Sara', 'Ali', 'sara12@gmail.com', '12345678', 5, 2000, 4),
...
(31, 'mostafa', 'ragab', 'mostafa1@yahoo.com', '123456', 3, 2000, 1),
...
--
ALTER TABLE `during_Auction`
  MODIFY `During_Auction_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `sequrityQ_User`
  MODIFY `SequrityQ_U_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
